      ...
      <section className="relative flex-1 flex flex-col items-center justify-center px-4 py-12 md:py-20">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center w-full">
          ...
          >
            ...
            >
              Domina SQL paso a paso con ejercicios prácticos y
              retroalimentación inmediata. Desde conceptos básicos hasta
              consultas avanzadas.
            </motion.p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground/40">
              © {new Date().getFullYear()} sql4All. Aprende SQL de forma
              interactiva.
            </p>
          </motion.div>
        </div>
