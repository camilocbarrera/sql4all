...
const sqlCommands: SqlCommand[] = [
  {
    ...
    examples: [
      { code: 'SELECT * FROM usuarios', description: 'Selecciona todas las columnas' },
      { code: 'SELECT nombre, email FROM usuarios', description: 'Selecciona columnas específicas' },
      { code: 'SELECT DISTINCT ciudad FROM usuarios', description: 'Valores únicos' },
      { code: 'SELECT * FROM usuarios LIMIT 5', description: 'Limitar resultados' },
    ],
  },
  {
    id: 'where',
    ...
    examples: [
      { code: "SELECT * FROM usuarios WHERE activo = true", description: 'Condición de igualdad' },
      { code: 'SELECT * FROM usuarios WHERE edad > 30', description: 'Comparación numérica' },
      { code: "SELECT * FROM usuarios WHERE ciudad IN ('Madrid', 'Barcelona')", description: 'Lista de valores' },
      { code: "SELECT * FROM usuarios WHERE nombre LIKE 'A%'", description: 'Búsqueda con patrón' },
      { code: 'SELECT * FROM usuarios WHERE edad BETWEEN 25 AND 35', description: 'Rango de valores' },
    ],
  },
  {
    id: 'orderby',
    ...
    tags: ['ordenar', 'sort'],
    examples: [
      { code: 'SELECT * FROM usuarios ORDER BY nombre', description: 'Orden ascendente (por defecto)' },
      { code: 'SELECT * FROM usuarios ORDER BY edad DESC', description: 'Orden descendente' },
      { code: 'SELECT * FROM usuarios ORDER BY ciudad, nombre', description: 'Múltiples columnas' },
    ],
  },
  {
    id: 'join',
  ...
  },
  {
    ...
    examples: [
      { code: 'SELECT COUNT(*) FROM usuarios', description: 'Contar registros' },
      { code: 'SELECT SUM(monto) FROM pedidos', description: 'Sumar valores' },
      { code: 'SELECT AVG(edad) FROM usuarios', description: 'Promedio' },
      { code: 'SELECT MIN(edad), MAX(edad) FROM usuarios', description: 'Mínimo y máximo' },
    ],
  },
  {
    id: 'groupby',
